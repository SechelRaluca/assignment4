 ...
 * 
 */
@WebServiceClient(name = "AdminServiceImplService", targetNamespace = "http://implementation/", wsdlLocation = "http://localhost:9090/admin?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADMINSERVICEIMPLSERVICE_QNAME = new QName("http://implementation/", "AdminServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/admin?wsdl");
    ...
    public AdminServiceImpl getAdminServiceImplPort() {
        return super.getPort(new QName("http://implementation/", "AdminServiceImplPort"), AdminServiceImpl.class);
    }
    ...
    public AdminServiceImpl getAdminServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://implementation/", "AdminServiceImplPort"), AdminServiceImpl.class, features);
    }
